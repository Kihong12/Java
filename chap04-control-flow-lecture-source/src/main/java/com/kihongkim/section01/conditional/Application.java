package com.kihongkim.section01.conditional;
...
//        c_ifElseIf.imporveIfElseIfStatement();

        D_swtich d_swtich = new D_swtich();
//        d_swtich.testsimpleSwitchStatement();
        d_swtich.improvesimpleSwitchStatement();
    }
}
